...
const benefits = [
  {
    ...
    description: 'Сотни постов по съёмке, алгоритмам и работе с брендами — фильтруй по теме в один тап.',
  },
  {
    icon: Users,
    title: 'Своё комьюнити',
    description: 'WhatsApp-чат, где можно задать «глупый» вопрос и получить честный ответ без осуждения.',
  },
  {
    icon: Zap,
    title: 'Живые разборы',
    description: 'Разбор профилей, трендов и кейсов каждую неделю — чтобы применять знания сразу.',
  },
  {
    icon: Archive,
    title: 'Оффлайн-встречи',
    description: 'Нетворкинг и коллаборации с другими создательницами контента в Словении.',
  },
]
