...
import { ONBOARDING_PATH, ADMIN_POSTS_CREATE_PATH, ADMIN_CATEGORIES_PATH, ADMIN_MEMBERS_PATH, ADMIN_SETTINGS_PATH } from '@/lib/app-routes'
...
const adminItems = [
  ...
  },
  {
    ...
    label: 'Kategorije',
    ariaLabel: 'Upravljanje kategorij',
    icon: (
      <svg
        className="size-5"
        fill="none"
  ...
  },
  {
    ...
    label: 'Nastavitve',
    ariaLabel: 'Nastavitve administracije',
    icon: (
      <svg
        className="size-5"
        fill="none"
