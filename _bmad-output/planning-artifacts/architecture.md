...
│   │   │   ├── components/     # Smart: FeedContainer / Dumb: PostCard, GalleryGrid
...
- **MVP Content Feed:** `src/features/feed/` (Включает нормированные данные, `PostCard`, `GalleryGrid`, пагинацию через Supabase с учетом JOIN `post_media`).
