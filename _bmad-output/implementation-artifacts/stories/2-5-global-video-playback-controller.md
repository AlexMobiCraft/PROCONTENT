...
- `src/components/feed/GalleryGrid.tsx` — интеграция `VideoPlayer` для `media_type='video'`
- `tests/unit/components/feed/GalleryGrid.test.tsx` — добавлен mock `VideoPlayer`
