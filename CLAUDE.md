...
- **Language**: `lang="si"`, контент и UI на словенском языке
...
Вся коммуникация, комментарии в коде, документация и commit-сообщения ведутся на **русском языке**. Технические термины, идентификаторы кода и названия инструментов остаются на английском, контент и UI на словенском языке.
