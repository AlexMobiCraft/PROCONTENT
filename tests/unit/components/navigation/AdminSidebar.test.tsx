...
describe('AdminSidebar', () => {
  it('рендерит все 3 nav-пункта', () => {
    mockPathname.mockReturnValue('/admin/posts/create')
    render(<AdminSidebar />)
  ...
  it('активный пункт при pathname=/admin/categories получает aria-current="page"', () => {
    mockPathname.mockReturnValue('/admin/categories')
    render(<AdminSidebar />)
