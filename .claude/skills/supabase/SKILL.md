...
## PROCONTENT Project Override (Self-Hosted Supabase)

**Этот проект использует self-hosted Supabase на VPS (Hetzner), а НЕ Supabase Cloud.**
...
**Пустой ответ = успех** для DDL-команд (ALTER TABLE, CREATE INDEX и т.п.).
